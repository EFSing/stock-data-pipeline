...
- HiThink CN API capability/provenance smoke test（本独立分支）：2026-08-27 17:52:18 +08:00 对代码表、CSI300/500/1000 成分、market-dump 签名端点、复权因子和交易日历做 bounded GET；API Key 未配置，7/7 HTTP 200 但 `code=2003`，原始响应已保存并哈希，当前不能证明真实数据权限或 as-of 能力。
