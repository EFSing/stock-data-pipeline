...
- Phase 5K-B0 Development Validation Dataset Acquisition Contract Freeze（本独立分支，PR 待创建）：新增机器可读 contract `SETUP_03-PHASE5K-B0-DATASET-ACQUISITION-CONTRACT-2026-08-27-v1`，canonical hash `sha256:daed425278bf7b2cca00ede87b56dddc3bc9d47be51508a6800369105f2da039`，状态 `DATASET_ACQUISITION_CONTRACT_FROZEN_NOT_ACQUIRED`。固定 2017-01-01 至 2026-08-26 本地交易日窗口、CN HiThink forward-adjusted、US IBKR ADJUSTED_LAST、canonical schema、raw metadata、QC/冲突/缺失 bar、严格 reserve rank、40/40 roster 与 8/40/6000 coverage gates、40/5 warmup 依赖及 B1 manifest schema；纯 research loader/test 未获取正式 OHLCV、未运行 SETUP_03、未查看 CONFIRMED/收益指标/OOS、未修改 production/Sheets。
