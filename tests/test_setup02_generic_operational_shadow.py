...
from scripts.run_setup02_generic_operational_shadow import (
    run_setup02_generic_operational_shadow,
)


class Setup02GenericOperationalShadowTests(unittest.TestCase):
    def test_synthetic_shadow_covers_setup02_operational_gate(self):
        with tempfile.TemporaryDirectory() as directory:
            report = run_setup02_generic_operational_shadow(directory)
            report_path = Path(directory, "setup02_generic_operational_shadow.json")
            csv_path = Path(directory, "setup02_generic_operational_shadow.csv")
